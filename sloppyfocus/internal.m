...
/// hs._ckol.sloppyfocus._focusByPidAndWindowID(pid, wid [, fpid, fwid]) -> boolean
/// Function
...
//   require("hs._ckol.sloppyfocus.internal") -> luaopen_hs__ckol_sloppyfocus_internal
int luaopen_hs__ckol_sloppyfocus_internal(lua_State *L) {
